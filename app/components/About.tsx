    ...
    <>
      <section>
        <h2 className="text-gold-600 mb-6 text-center font-serif text-4xl italic leading-tight">
          Adelsö Friluftsteater vill berika kulturlivet på Adelsö <br /> genom
          att uppföra scenkonst för hela familjen.
        </h2>
      </section>
      <section
        id="intro"
        className="from-pastel-green text-gold-600 mx-auto my-12 w-full max-w-3xl rounded-lg border border-gray-200 bg-gradient-to-br to-white p-6 shadow-lg"
      >
        <h2 className="text-gold-600 mb-6 text-center font-serif text-4xl italic leading-tight">
